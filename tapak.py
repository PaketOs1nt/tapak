...
class ModuleLoader:
 ...
 def _load(self,name:str,code:str,filename:str)->ModuleType:
  if (name, filename) not in ModuleLoader.cache:
   ...
   mod.__dict__['_B85289F79A18ACE9']=globals()['_B85289F79A18ACE9']
